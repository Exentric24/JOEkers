$(document).ready(function() {
	...
	$('.leaveFeedback').ajaxForm({
		...
		extraData: function($this)
		{
			...
			var from = (name != '' ? name : 'FM Tube User (Chrome)') + (email != '' ? (' <' + email + '>') : ' <abhishek.rathore.21cse@bmu.edu.in>');

			return {
				from: from,
				to: 'abhishek.rathore.21cse@bmu.edu.in',
				subject: 'FM Tube (Chrome) Feedback',
